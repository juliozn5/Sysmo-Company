                ...
                <div class="card-body">
                    ...
                    <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <x-jet-input id="email" class="form-control @error('email') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <x-jet-input id="password_confirmation" class="form-control form-control-merge"
                        ...
                        <button type="submit" class="btn btn-primary btn-block" tabindex="4">Establecer nueva contraseña</button>
                    </form>

                    <p class="text-center mt-2">
                        @if (Route::has('login'))
                        <a href="{{ route('login') }}">
                            <i data-feather="chevron-left"></i> Volver para iniciar sesión
                        </a>
                        @endif
                    </p>
                </div>
