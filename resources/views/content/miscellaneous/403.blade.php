...
<div class="misc-wrapper">
    ...
    <div class="misc-inner p-2 p-sm-3">
        <div class="w-100 text-center">
            <h1 class="mb-1">No estas autorizado! 🔐</h1>
            <p class="mb-2">La ruta a la que quieres acceder no esta autorizada para su tipo de cuenta.</p>
            <a class="btn btn-primary mb-1 btn-sm-block" href="{{url('/')}}">Volver a la pagina de inicio</a>
